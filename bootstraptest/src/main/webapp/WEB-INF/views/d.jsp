	...
	<div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="navigation-index">
	    	<ul class="nav navbar-nav navbar-right">
            	<li class="active"><a href=".">COMU</a></li>
     ...
     <div class="col-sm-12">
		<form class="form" method="" action="">
			...
			<div class="footer text-center">
				...
				<hr>
				<a href="#joinModal" class="btn btn-simple btn-primary btn-lg">
				<button class="btn btn-primary btn-simple" data-toggle="modal" data-target="#joinModal">JOIN</button>
