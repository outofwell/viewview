							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group label-floating">
										...
										<textarea class="form-control" rows="4" name="sample"
											id="sample"></textarea>
									</div>
								</div>
								<div class="col-md-2">
									<button class="btn btn-primary" id="samplePlay">▶</button>
									<button class="btn btn-primary" id="under">▼</button>
								</div>
							</div>
							<div class="form-group label-floating">
								<label class="control-label">Code</label>
								<textarea class="form-control" rows="10" name="file_ori"
									id="code">${file.file_ori}</textarea>
							</div>
							<div class="row">
								<div class="col-md-10">
								...
								<div class="col-md-2">
									<button class="btn btn-primary" id="mainPlay">▶</button>
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-4">
										...
										<img id="imgView" src="resources/covers/${file.cover_re}"
											onERROR="this.src='resources/assets/img/robot.png'"
											style="width: 100px; height: 100px; border-radius: 100px;">
										<label class="btn btn-primary btn-sm"> get
											Cover&hellip; <input type="file" style="display: none;"
											id="imgInp" name="upload" />
										</label>
									</div>
									<div class="col-md-8">
										<div class="form-group">
											<div class="form-group label-floating">
												<label class="control-label">Title</label> <input
													type="text" class="form-control" name="file_title"
													value="${file.file_title}" /><br>
											</div>
							</form>
